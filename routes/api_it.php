...
use App\Http\Controllers\ItStaff\PermissionModuleMasterController;
use Illuminate\Support\Facades\Route;

Route::prefix('v1/it-admin')->group(function () {
    Route::post('login', [AuthController::class, 'login']);
    Route::post('create-subadmin', [AuthController::class, 'store']);
    Route::middleware(['auth:itstaff'])->group(function () {
        ...
        // Permisson Module
        Route::apiResource('permission-module-masters', PermissionModuleMasterController::class);
    });
});
